 ...
 */
public class SM_INIT_bak extends ClientPacket {
    ...
    public SM_INIT_bak(LoginConnection connection, SecretKey blowfishKey) {
        this(connection.getEncryptedModulus(), blowfishKey.getEncoded(), connection.getSessionId());
    }

    private SM_INIT_bak(byte[] publicRsaKey, byte[] blowfishKey, int sessionId) {
        //初始数据包的opCode为0x00
        super(0x00);
