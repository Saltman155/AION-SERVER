...
/**
 * 客户端消息解码器
 *      这边客户端在发送消息时，会出现分包的问题，所以通过实现这个 LengthFieldBasedFrameDecoder，
 *      自定义长度解码器来解决。
 * @author saltman155
 * @date 2019/10/17 0:16
 */

public class ClientPacketFrameDecoder extends LengthFieldBasedFrameDecoder {

    private static final Logger logger = LoggerFactory.getLogger(ClientPacketFrameDecoder.class);
    ...
    public ClientPacketFrameDecoder() {
