...
/**
 * 基于BlowFish对称加密算法的一个改造实现
 * @author EvilSpirit
 */
public class LBlowfishCipher {
	 ...
	 * Constants - Pi value
	 */
	private static final int[] S_BOX_INIT_0 = {
	 ...
	 * Constants - Pi value
	 */
	private static final int[] S_BOX_INIT_1 = {
	 ...
	 * Constants - Pi value
	 */
	private static final int[] S_BOX_INIT_2 = {
	 ...
	 * Constants - Pi value
	 */
	private static final int[] S_BOX_INIT_3 = {
	 ...
	 *          Blowfish Key
	 */
	public LBlowfishCipher(byte[] blowfishKey) {
		pArray = new int[18];
	...
	public void updateKey(byte[] blowfishKey) {
		...
		System.arraycopy(S_BOX_INIT_0, 0, sBoxes[0], 0, 256);
		System.arraycopy(S_BOX_INIT_1, 0, sBoxes[1], 0, 256);
		System.arraycopy(S_BOX_INIT_2, 0, sBoxes[2], 0, 256);
		System.arraycopy(S_BOX_INIT_3, 0, sBoxes[3], 0, 256);
		initArrays();
	}
